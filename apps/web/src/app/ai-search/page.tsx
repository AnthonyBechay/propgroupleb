...
export default function AISearchPage() {
  return (
    <div className="min-h-screen bg-stone-50">
      {/* Header */}
      <section className="bg-[#1B4965] text-white py-8 sm:py-10">
      ...
      <section className="pb-12">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-lg font-bold text-stone-900 text-center mb-6">How It Works</h2>
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                <div key={item.step} className="text-center">
                  <div className="w-9 h-9 bg-[#1B4965] text-white rounded-full flex items-center justify-center mx-auto mb-2 text-sm font-bold">
                    {item.step}
                  </div>
                  <h3 className="font-semibold text-stone-900 text-sm mb-0.5">{item.title}</h3>
            ...
            <div className="mt-8 text-center">
              <Link
                href="/properties"
                className="inline-flex items-center gap-2 text-sm font-medium text-[#1B4965] hover:underline"
              >
