  ...
  return (
    <div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between mb-6">
        ...
        <button
          onClick={openCreate}
          className="mt-4 sm:mt-0 inline-flex items-center gap-2 px-4 py-2 bg-[#1B3A5C] text-white rounded-lg hover:bg-[#24507D] transition-colors text-sm font-semibold"
        >
      ...
      {loading ? (
        ...
        <div className="bg-white shadow rounded-lg p-12 text-center">
          ...
          <button
            onClick={openCreate}
            className="inline-flex items-center gap-2 px-4 py-2 bg-[#1B3A5C] text-white rounded-lg hover:bg-[#24507D] transition-colors text-sm font-semibold"
          >
            <Plus className="h-4 w-4" />
            Create First Guide
          </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          {filtered.map((guide) => (
            <div
              key={guide.id}
              className="bg-white rounded-xl border border-slate-200 overflow-hidden hover:border-[#1B3A5C] transition-colors"
            >
              {guide.imageUrl && (
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[#1B3A5C]"
                >
                  {COUNTRIES.map((c) => (
                    <option key={c.value} value={c.value}>
                      {c.label}
            ...
            <div className="sticky bottom-0 bg-slate-50 border-t border-slate-200 px-6 py-4 flex items-center justify-end gap-2">
              ...
              <button
                onClick={handleSave}
                disabled={saving}
                className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-[#1B3A5C] rounded-lg hover:bg-[#24507D] disabled:opacity-50"
              >
                {saving ? (
