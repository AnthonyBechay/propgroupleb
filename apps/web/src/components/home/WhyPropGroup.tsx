...
const testimonials = [
  {
    ...
    rating: 5,
    text: "After what happened to deposits in Lebanon, I needed something tangible outside the country. PropGroup walked me through a seafront unit in Batumi — handover came on time and the rental management runs it through the summer season without me touching it.",
    investment: '$185k invested',
    returns: '12.4% annual yield',
  },
  {
    name: 'Nour El-Khoury',
    ...
    location: 'Dubai, UAE',
    rating: 5,
    text: "I was looking past Dubai for diversification. Georgia's residency route and visa-free access made it the obvious next step. The team handled the legal side in Tbilisi and we closed in under three weeks.",
    investment: '$420k invested',
    returns: '14.1% annual yield',
  },
  {
    name: 'Rami Saliba',
    role: 'Civil Engineer',
    location: 'Beirut, Lebanon',
    rating: 5,
    text: "Bought off-plan in Gonio two years ago. The handover delivered exactly what was on the floor plan, and the area appreciated faster than what we were seeing on the Beirut coast. Already looking at a second unit.",
    investment: '$260k invested',
    returns: '11.8% annual yield',
  },
]
