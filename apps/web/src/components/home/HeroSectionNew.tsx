...
export function HeroSectionNew() {
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden w-full">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[#0F2137] via-[#1B3A5C] to-[#24507D]" />
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center space-y-4 sm:space-y-6 mb-10 sm:mb-12">
            ...
            <p className="text-lg sm:text-xl text-white/70 max-w-2xl mx-auto">
              Premium apartments with verified ROI, flexible payment plans, and expert guidance from listing to handover.
            </p>
          </div>
