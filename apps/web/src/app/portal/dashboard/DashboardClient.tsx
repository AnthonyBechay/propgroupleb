    ...
    <div className="min-h-screen bg-slate-50">
      <div className="pg-container max-w-7xl mx-auto py-6 sm:py-8 lg:py-12">
        ...
        <div className="mb-8 sm:mb-12">
          ...
          <p className="pg-text-lg text-slate-600 max-w-2xl">
        ...
        <div className="pg-grid pg-grid-cols-1 lg:pg-grid-cols-3 mb-8 sm:mb-12">
          ...
          <div className="lg:col-span-2 pg-card">
            <div className="pg-card-header">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <h2 className="pg-text-xl font-bold text-slate-900">Market Trends</h2>
                <select 
                  value={selectedPeriod}
                  onChange={(e) => setSelectedPeriod(e.target.value)}
                  className="px-4 py-2 border border-slate-200 rounded-lg text-sm bg-white text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#1B3A5C] focus:border-transparent"
                >
            ...
            <div className="pg-card-content">
              ...
              <div className="space-y-4">
                {marketTrends.length > 0 ? marketTrends.map((market) => (
                  <div key={market.country} className="flex items-center justify-between p-4 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors">
                    <div className="flex items-center space-x-4">
                      <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-md">
                        <MapPin className="w-6 h-6 text-white" />
                      </div>
                      <div>
                        <h3 className="font-semibold text-slate-900">{market.country}</h3>
                    ...
                    <div className="flex items-center space-x-2">
                      <span className={`text-lg font-semibold ${
                        ...
                        market.trend === 'down' ? 'text-red-600' : 'text-slate-600'
                      }`}>
              ...
              <Link 
                href="/portal/market-analysis" 
                className="mt-6 inline-flex items-center text-[#1B3A5C] hover:text-[#24507D] font-medium transition-colors"
              >
          ...
          <div className="pg-card">
            <div className="pg-card-header">
              <h2 className="pg-text-xl font-bold text-slate-900">Recent Activity</h2>
            </div>
            <div className="pg-card-content">
              <div className="space-y-4">
              ...
              <Link 
                ...
                className="mt-6 inline-flex items-center text-[#1B3A5C] hover:text-[#24507D] font-medium text-sm transition-colors"
              >
                View all activity
        ...
        <div className="pg-premium-card bg-[#1B3A5C] text-white shadow-xl rounded-2xl">
          <div className="p-6 sm:p-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
              ...
              <Link 
                href="/portal/portfolio" 
                className="bg-white text-[#1B3A5C] px-6 py-3 rounded-xl font-semibold hover:bg-blue-50 transition-all transform hover:scale-105 shadow-lg inline-flex items-center"
              >
                View Portfolio
...
function StatCard({ icon, title, value, change, trend, color }: any) {
  ...
  return (
    <div className="pg-stat-card">
      ...
      <h3 className="text-sm text-slate-600 mb-2 font-medium">{title}</h3>
      <p className="pg-text-2xl sm:pg-text-3xl font-bold text-slate-900 mb-2">{value}</p>
      <p className={`text-sm ${
...
function QuickActionCard({ href, icon, title, description, color }: any) {
  const colorClasses: Record<string, string> = {
    blue: 'bg-[#1B3A5C] hover:bg-[#24507D]',
    green: 'bg-emerald-600 hover:bg-emerald-700',
    purple: 'bg-[#C49A2E] hover:bg-[#A98327]',
    orange: 'bg-slate-600 hover:bg-slate-700',
  }
  ...
  return (
    ...
    >
      <div className="pg-card-content">
        ...
        <h3 className="font-bold text-slate-900 mb-2 pg-text-lg">{title}</h3>
